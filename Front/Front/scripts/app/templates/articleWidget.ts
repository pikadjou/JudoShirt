module JudoShirt {
	...
	JudoShirtApp.JudoShirtApp.directive(TemplateArticleWidget.Name, JudoShirtApp.Application.GetDirectiveFactory<TemplateArticleWidget>(TemplateArticleWidget));
}