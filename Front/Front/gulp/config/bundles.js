...
function prepare()
{
    ...
    return {
        ...
        baseUrl: cfg().path.output + '/Scripts/app',

        //The directory path to save the output. If not specified, then
        //the path will default to be a directory called "build" as a sibling
        //to the build file. All relative paths are relative to the build file.
        dir: cfg().path.output + '/Scripts/app',
        ...
        modules: [
            ...
            },
            {
                ...
                //include: ['durandal/**/*.js', 'foundation/**/*.js', 'text.js', 'spike-sdk.js.src', 'slick.min', 'jquery-2.1.1.min', 'jquery-ui-1.9.0.min', 'jquery.cookiecuttr', 'jquery.cookie'],
                //include: ['durandal/**/*.js', 'foundation/**/*.js', 'text.js', 'spike-sdk.js.src', 'slick.min','jquery-ui-1.9.0.min', 'jquery.cookiecuttr', 'jquery.cookie'],
